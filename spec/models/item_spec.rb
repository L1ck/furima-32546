  ...
  describe '商品出品' do
    ...
    context '商品出品がうまくいかないとき' do
      ...
      it 'それぞれのidで1が選択された場合は登録されない' do
        ...
        @item.valid?
        expect(@item.errors.full_messages).to include("Category must be other than 1", "State must be other than 1", "Delivery fee must be other than 1", "Area must be other than 1", "Delivery day must be other than 1")
      end
